...
docpadConfig = {
  ...
  templateData:
    ...
    getExercises : () ->
      result = 
        'courseName' : 'UK_W20_Mind_and_Reality'
        'variant' : '2020_21'
        'description' : 'These exercises are for students taking Mind and Reality in 2020-21.'
    ...
    _getLectures : (lectures, exType) ->
      baseurl = 'https://mind-and-reality.butterfill.com'
      result = []
  ...
  collections:
    lectures: -> @getCollection('documents').findAll({basename:/^(?!.*_stream$)(?!.*_stream_backup$)lecture_\w+/}, [basename:1])
